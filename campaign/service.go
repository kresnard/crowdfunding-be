...
type Service interface {
	...
	GetCampaignByID(input GetCampaingDetailInput) (Campaign, error)
...
func (s *service) GetCampaignByID(input GetCampaingDetailInput) (Campaign, error) {
...
func (s *service) SaveCampaignImage(input CreateCampaignImageInput, fileLocation string) (CampaignImage, error) {
	...
	if input.IsPrimary {
		...
		_, err := s.repository.MarkAllImagesAsNonPrimaty(input.CampaignID)
		if err != nil {
			return CampaignImage{}, err
		}
	}
